...
NOTES:
\begin{itemize}
\item Not all platforms support this interface. AIX (confirmed 7.1) supports IPv6 but not IPv4; and macOS (confirmed 10.10) supports IPv4 but not IPv6.
...
NOTES:
\begin{itemize}
\item Not all platforms support this interface. See \syscall{recvfromto}.
